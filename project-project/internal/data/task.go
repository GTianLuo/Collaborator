...
func (t *Task) ToTaskDisplay() *TaskDisplay {
	...
	td.CreateBy = strconv.FormatInt(t.CreateBy, 10)
	td.ProjectCode = strconv.FormatInt(t.ProjectCode, 10)
	td.DoneBy = strconv.FormatInt(t.DoneBy, 10)
	td.AssignTo = strconv.FormatInt(t.AssignTo, 10)
	td.StageCode = strconv.Itoa(t.StageCode)
	td.Pcode = strconv.FormatInt(t.Pcode, 10)
	td.VersionCode = strconv.FormatInt(t.VersionCode, 10)
	td.FeaturesCode = strconv.FormatInt(t.FeaturesCode, 10)
	td.ExecuteStatus = t.GetExecuteStatusStr()
	td.Code = strconv.FormatInt(t.Id, 10)
	td.CanRead = 1
...
func (t *Task) ToMyTaskDisplay(p *Project, name string, avatar string) *MyTaskDisplay {
	...
	td.TemplateCode = p.TemplateCode
	td.OrganizationCode = strconv.FormatInt(p.OrganizationCode, 10)
	return td
}
