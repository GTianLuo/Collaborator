...
func (a *MemberAccount) ToDisplay() *MemberAccountDisplay {
	...
	copier.Copy(md, a)
	md.Code = strconv.FormatInt(a.Id, 10)
	md.MembarAccountCode = md.Code
	md.MemberCode = strconv.FormatInt(a.MemberCode, 10)
	md.OrganizationCode = strconv.FormatInt(a.OrganizationCode, 10)
	md.DepartmentCode = strconv.FormatInt(a.DepartmentCode, 10)
